...
#6
cd jigglypuff0
chmod u+rwx Stoutland
cd tynamo2/sudowoodo
cd ..
chmod u+rwx sudowoodo
cd ..
cp -r tynamo2 jigglypuff0/Stoutland
chmod 733 jigglypuff0/Stoutland
chmod 357 tynamo2/sudowoodo
#7
...
cd..
#4
rm charmander1/poliwhirlarcheo*
#5
chmod -R u+rwx tynamo2
rm -r tynamo2
#6
cd jigglypuff0
chmod -R u+rwx Stoutland
rm -r Stoutland